...
var nome = "Diego";
var idade = 23; //Que horrror
// console.log('Meu nome é + '+nome+' e tenho '+idade+' anos ');
// Que maravilha    

console.log("Meu nome \xE9 ".concat(nome, " e tenho ").concat(idade, " anos.")); // Se o nome da variavel for igual ao nome da propriedade, deixa apenas um nome sem precisa repetir
